...
class Tinder():
    ...
    def loadRegisterGUI(self):
        ...
        self.passwordLabel = Label(self.root, text="Enter Password", bg="#E7497C", fg="#fff")
    ...
    def headerMenu(self):
        ...
        filemenu.add_command(label="View Profile", command=lambda: self.fetchOtherUsers())
    ...
    def loadEditProfileGUI(self):
        ...
        self.editBtn = Button(self.root, text="Save", command=lambda: self.editProfile())
        self.editBtn.pack()
    ...
    def editProfile(self):
        ...
        if response==1:
            destination = "C:\\Users\\ANUSHKA\\PycharmProjects\\Tinder\\images" + self.pathname.split("/")[-1]
    ...
    def userProfileGUI(self, data, mode=1, index=0):
        ...
        # 4. City
        self.locationLabel = Label(self.frame, text=" from " + data[0][6], bg="#E7497C", fg="#fff")
    ...
    def proposeUser(self, receiver_id):
        ...
        if response==1:
            ...
            messagebox.showerror("Already Proposed", "Saale despo!")
    ...
    def fetchOtherUsers(self):
        #fetch data of all the users except the logged in user()
